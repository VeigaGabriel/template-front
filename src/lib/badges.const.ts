export const ComponentBadgeList = [
  {
    slug: 'new',
    name: 'New',
    description: 'This component is new and has not been tested by the community yet.',
  },
  {
    slug: 'updated',
    name: 'Updated',
  ...
  },
  {
    slug: 'deprecated',
    name: 'Deprecated',
    description: 'This component is deprecated and will be removed in the future.',
  },
  {
    slug: 'experimental',
    name: 'Experimental',
